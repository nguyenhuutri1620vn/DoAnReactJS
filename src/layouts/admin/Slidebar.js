        ...
        if (users.role_as === 1) {
            slide_HTML =
                <div className="nav">
                    ...
                    <Link className="nav-link collapsed" to="#" data-bs-toggle="collapse" data-bs-target="#DiscountPages" aria-expanded="false" aria-controls="collapsePages">
                        <div className="sb-nav-link-icon"><i className="fas fa-archway"></i></div>
                        Mã giảm giá
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div>
                    </Link>
                    <div className="collapse" id="DiscountPages" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav className="sb-sidenav-menu-nested nav">
                            <Link className="nav-link" to="/admin/add-discount">Tạo</Link>
                            <Link className="nav-link" to="/admin/view-discounts">Danh sách</Link>
                        </nav>
                    </div>
